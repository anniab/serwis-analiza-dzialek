...
//////end DOM creations
	...
	_recordsFromLayer: function(_layer, _records) {	//return table: key,value from layer
		var that = this,
		...
		_layer.eachLayer(function(layer) {
			...
			if(layer instanceof L.Marker || layer instanceof L.CircleMarker)
			{
				if(that._getPath(layer.options,propName))
				{
					loc = layer.getLatLng();
					loc.layer = layer;
					_records[ that._getPath(layer.options,propName) ] = loc;			
					...
					loc = layer.getLatLng();
					loc.layer = layer;
					_records[ that._getPath(layer.feature.properties,propName) ] = loc;
            ...
            else if(layer.hasOwnProperty('feature'))//GeoJSON
			{
				if(layer.feature.properties.hasOwnProperty(propName))
				{
					...
					loc.layer = layer;			
					_records[ layer.feature.properties[propName] ] = loc;
				}
				else
					throw new Error("propertyName '"+propName+"' not found in feature");
			}
			else if(layer instanceof L.LayerGroup){ //recursion!
				this._recordsFromLayer(layer,_records);
			}
...
//	in this way every record can have a free structure of attributes, only 'loc' is required
		...
		if(this.options.layer)
		{
			...
			this._recordsCache = {};
			this._recordsFromLayer(this._layer, this._recordsCache);
